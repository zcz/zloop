...
public class LoginFragmentYin extends Fragment implements OnClickListener {
	 ...
	 * argument.
	 */
	static LoginFragmentYin newInstance(String name, String password) {
		LoginFragmentYin f = new LoginFragmentYin();
